...
$(document).ready(function () {
    $("a.btn-primary-option:contains('Apply Online')").click(function() {

       		modalone.style.display = "block";

    });

      $("a.btn-primary-option:contains('Click for Subsequent Contribution')").click(function() {

       		modaltwo.style.display = "block";

    });

     $("#continue_one").click(function() {

       		getAllKarvyParams();

    });

      $("#continue_two").click(function() {

       		getAllNPSKarvyParams();
...
/*var btnOne = $("a.btn-primary-option:contains('Apply Online')");//document.getElementById("btnOne");
var btnTwo = $("a.btn-primary-option:contains('Click for Subsequent Contribution')");//document.getElementById("btnTwo");

var continueOne = document.getElementById("continue_one");
var continueTwo = document.getElementById("continue_two");*/
...
continueTwo.onclick = function () {
 ...
 function OpenInNewTabWinBrowser(url, UniqueTranCodeval, CRACodeval, EncUniqueKeyval, RandomNoval) {
        ...
        function getAllKarvyParams() {
            console.log("calling getAllKarvyParams");
            $.ajax({
                type: "POST",
                url: "/bin/microsites/karvyServlet",
                data: {
                    data1: "Ashish",
                    flagData: "Y"
                },
                success: function (msg) {
                    ...
                    OpenInNewTabWinBrowser("https://cra.kfintech.com/POPONLINE/POPAuthenticate", UniqueTranCodeval, CRACodeval, EncUniqueKeyval, RandomNoval);
...
function getAllNPSKarvyParams() {
	$.ajax({
		type : "POST",
		url : "/bin/microsites/karvySubsequentServlet",
		data : {
			data1 : "Ashish",
			flagData:"Y"
		},
		success : function(msg) { 
            ...
            console.log(msg);
           // alert(msg);
            var responsJav = msg.msg;
			var fields = responsJav.split('$');
            ...
            console.log(msg);
			//$('#npsdiv').hide();
        	OpenInNewTabWinBrowsernps("https://cra.kfintech.com/poponline/POPAuthContribution",UniqueTranCodeval,CRACodeval,EncUniqueKeyval,ClienData,ContFlag,RandomNoval);
