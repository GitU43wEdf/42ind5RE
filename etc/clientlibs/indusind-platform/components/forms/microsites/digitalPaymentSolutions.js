...
$(document).ready(function () {
    $('.nav ul li.corporate_list ul a').bind('click', function (e) {
        e.preventDefault();
        $('.nav ul li ul').hide();
        //$(this).parent().parent().parent('li.sublist > a').addClass('active');
    ...
    $('.nav ul li.consumer_list ul a').bind('click', function (e) {
        e.preventDefault();
        $('.nav ul li ul').hide();
        //$(this).parent().parent().parent('li.sublist > a').addClass('active');
        var target = $(this).attr("href");
    ...
    $('.nav ul li.sublist > a').click(function (e) {
        e.preventDefault();
        e.stopPropagation();
        //$('.nav ul li.sublist a').removeClass('active');
...
$(window).scroll(function () {
    var scrollDistance2 = $(window).scrollTop() + 85;
    $('.slide:lt(2)').each(function (i) {
        if ($(this).position().top <= scrollDistance2) {
            $('.nav ul li.sublist a.active').removeClass('active');
            $('.nav ul li.sublist > a').eq(i).addClass('active');
        }
    });
}).scroll();
